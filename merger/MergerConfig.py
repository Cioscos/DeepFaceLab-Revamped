...
class MergerConfig(object):
    ...
    def ask_settings(self):
        ...
        io.log_info(s)
        self.sharpen_mode = io.input_int ("Choose sharpen mode", 0, valid_list=self.sharpen_dict.keys(), help_message="Enhance details by applying sharpen filter.")
...
class MergerConfigMasked(MergerConfig):
    ...
    def ask_settings(self):
        ...
        io.log_info(s)
        mode = io.input_int ("Choose mode", mode_str_dict.get(self.default_mode, 1) )
        ...
        io.log_info(s)
        self.mask_mode = io.input_int ("Choose mask mode", 1, valid_list=mask_mode_dict.keys() )
